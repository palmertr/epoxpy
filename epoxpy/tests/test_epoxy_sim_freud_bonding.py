...
class TestLegacyBonding(BaseTest):
    ...
    @pytest.mark.long
    @pytest.mark.frued_bonding
    def test_epoxy_sim_freud_bonding_count(self, datadir, tmpdir):
        """
        Here we are testing if the legacy bonding routine and the freud bonding routine produce same results.
        :param datadir: 
        :param tmpdir: 
        :return: 
        """
